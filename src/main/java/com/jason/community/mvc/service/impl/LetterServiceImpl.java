...
import com.jason.community.mvc.mapper.LetterMapper;
...
public class LetterServiceImpl implements LetterService {
     ...
     */
    @Override
    public Page<Letter> getAllLetterBySearch(Map<String, Object> searchMap) {
        ...
        // 3.根据查询条件，执行查询
        return (Page<Letter>) letterMapper.selectByExample(example);
    }
