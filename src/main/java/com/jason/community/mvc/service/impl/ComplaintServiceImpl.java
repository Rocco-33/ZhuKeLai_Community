...
import com.jason.community.mvc.mapper.ComplaintMapper;
...
public class ComplaintServiceImpl implements ComplaintService {
     ...
     */
    @Override
    public Page<Complaint> getAllComplaintBySearch(Map<String, Object> searchMap) {
        ...
        if (StringUtil.isNotEmpty((String) searchMap.get("name"))) {
            criteria.andLike("reason", "%"+searchMap.get("name")+"%");
        }
        // 1.3 分页条件
