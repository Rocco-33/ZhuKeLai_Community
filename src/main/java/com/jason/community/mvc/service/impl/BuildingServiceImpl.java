...
import com.jason.community.mvc.mapper.BuildingMapper;
...
public class BuildingServiceImpl implements BuildingService {
     ...
     */
    @Override
    public Page<Building> getAllBuildingBySearch(Map<String, Object> searchMap) {
        ...
        if (StringUtil.isNotEmpty((String) searchMap.get("name"))) {
            criteria.andLike("description", "%"+searchMap.get("name")+"%");
        }
        // 1.3 分页条件
