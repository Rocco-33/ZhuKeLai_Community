...
import com.jason.community.mvc.mapper.AssetMapper;
...
public class AssetServiceImpl implements AssetService {
     ...
     */
    @Override
    public Page<Asset> getAllAssetBySearch(Map<String, Object> searchMap) {
        ...
        // 3.根据查询条件，执行查询
        return (Page<Asset>) assetMapper.selectByExample(example);
    }
    ...
    public void deleteByIds(List<Integer> ids) {
        ...
        for (Integer id : ids) {
            assetMapper.deleteByPrimaryKey(id);
        }
    }
